...
public class InternalSimulinkLexer extends Lexer {
    ...
    public final void mRULE_FLOAT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSimulink.g:741:12: ( ( '-' )? RULE_INT '.' RULE_INT )
            // InternalSimulink.g:741:14: ( '-' )? RULE_INT '.' RULE_INT
            {
            // InternalSimulink.g:741:14: ( '-' )?
            int alt1=2;
    ...
    public final void mRULE_FLOAT_X() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSimulink.g:743:14: ( ( '-' )? RULE_INT 'e-' RULE_INT )
            // InternalSimulink.g:743:16: ( '-' )? RULE_INT 'e-' RULE_INT
            {
            // InternalSimulink.g:743:16: ( '-' )?
            int alt2=2;
    ...
    public final void mRULE_INT_X() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSimulink.g:745:12: ( ( '-' )? RULE_INT )
            // InternalSimulink.g:745:14: ( '-' )? RULE_INT
            {
            // InternalSimulink.g:745:14: ( '-' )?
            int alt3=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSimulink.g:747:9: ( ( '$' )? ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '0' .. '9' )+ ( '.' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '0' .. '9' )+ )? )
            // InternalSimulink.g:747:11: ( '$' )? ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '0' .. '9' )+ ( '.' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '0' .. '9' )+ )?
            {
            // InternalSimulink.g:747:11: ( '$' )?
            int alt4=2;
            ...
            // InternalSimulink.g:747:21: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '0' .. '9' )+
            int cnt6=0;
            loop6:
            do {
                int alt6=2;
            ...
            // InternalSimulink.g:747:59: ( '.' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '0' .. '9' )+ )?
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // InternalSimulink.g:747:60: '.' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '0' .. '9' )+
                    {
                    match('.'); 
                    // InternalSimulink.g:747:64: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '-' | '0' .. '9' )+
                    int cnt7=0;
                    loop7:
                    do {
                        int alt7=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            // InternalSimulink.g:749:19: ( ( '0' .. '9' )+ )
            // InternalSimulink.g:749:21: ( '0' .. '9' )+
            {
            // InternalSimulink.g:749:21: ( '0' .. '9' )+
            int cnt9=0;
            loop9:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSimulink.g:751:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalSimulink.g:751:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalSimulink.g:751:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt12=2;
            ...
            switch (alt12) {
                case 1 :
                    // InternalSimulink.g:751:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalSimulink.g:751:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop10:
                    do {
                        int alt10=3;
                    ...
                    break;
                case 2 :
                    // InternalSimulink.g:751:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalSimulink.g:751:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop11:
                    do {
                        int alt11=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSimulink.g:753:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalSimulink.g:753:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalSimulink.g:753:24: ( options {greedy=false; } : . )*
            loop13:
            do {
                int alt13=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSimulink.g:755:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalSimulink.g:755:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalSimulink.g:755:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop14:
            do {
                int alt14=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSimulink.g:757:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalSimulink.g:757:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalSimulink.g:757:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt17=0;
            loop17:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalSimulink.g:759:16: ( . )
            // InternalSimulink.g:759:18: .
            {
            matchAny(); 
    ...
    static final String[] DFA18_transitionS = {
            "\11\20\2\17\2\20\1\17\22\20\1\17\1\20\1\14\1\20\1\11\2\20\1\15\4\20\1\4\1\7\1\20\1\16\12\10\1\20\1\6\5\20\32\13\1\3\1\20\1\5\1\12\1\13\1\20\32\13\1\1\1\20\1\2\uff82\20",
            "",
            "",
            "",
            "",
